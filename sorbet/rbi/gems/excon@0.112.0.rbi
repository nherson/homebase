...
class Excon::Connection
  ...
  # source://excon//lib/excon/connection.rb#528
  def proxy_from_env; end

  # source://excon//lib/excon/connection.rb#515
  def proxy_match_host_port(host, port); end

  # source://excon//lib/excon/connection.rb#507
  def raise_socket_error(error); end

  # source://excon//lib/excon/connection.rb#465
  def response(datum = T.unsafe(nil)); end

  # source://excon//lib/excon/connection.rb#556
  def setup_proxy; end

  # source://excon//lib/excon/connection.rb#476
  def socket(datum = T.unsafe(nil)); end

  # source://excon//lib/excon/connection.rb#487
  def sockets; end
...
# source://excon//lib/excon/constants.rb#22
